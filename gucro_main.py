...
class CoFruit(QMainWindow):
    ...
    def updateThresholdedImage(self):
        ...
        #i set this range as the max input
    ...
    def Analys(self):
        ...
        self.Brix = (-0.0101*self.Red) + 9.3606
        self.Hardness = (0.0148*self.Red) - 0.5989
        ...
        self.zhard.setText(f"{round(self.Hardness, 2)} kgF")
    ...
    def Save(self):
        ...
        print(f"BOT-Q0NT0L: {filename} masked image saved")
        ...
        data = {
            ...
            "Brix": [self.Brix],
            "Hardness": [self.Blue],
            "Major Diameter": [self.DMayor],
            "Minor Diameter": [self.DMinor]
        }
        ...
        print("BOT-Q0NT0L: CSV updated too fcking MORON!")
